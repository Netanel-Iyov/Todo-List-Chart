...
{{ include "Todo-List-Chart.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "Todo-List-Chart.selectorLabels" -}}
...
*/}}
{{- define "Todo-List-Chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "Todo-List-Chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
